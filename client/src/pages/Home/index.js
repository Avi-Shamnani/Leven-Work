  ...
  return (
    <>
      ...
      <div className="main-container mt-0 h-fit">
        ...
        <div className="main">
          <div className="step-1" id="steps">
            <div id="image-container" data-hover-text="Digital Marketing">
              <img src="images/image1.jpg" alt="" className="b-image" />
            </div>

            <div id="text">
              <h1 style={{ fontWeight: 'bold', fontSize: '32px' }}>Digital Marketing :</h1>
              <br />
              <p>
          ...
          <div className="step-2" id="steps">
            <div id="text">
              <h1 style={{ fontWeight: 'bold', fontSize: '32px' }}>Creative Services:</h1>
              <p>
                - Graphic Design <br />
                - Logo Design <br />
                - Branding <br />
            ...
            <div id="image-container" data-hover-text="Creative Services">
              <img src="images/image2.png" alt="" className="b-image" />
            </div>
          </div>
          ...
          <div className="step-3" id="steps">
            <div id="image-container" data-hover-text="Web Development">
                ...
                <img src="images/image3.jpg" alt="" class="b-image"/>

            </div>

            <div id="text"> <h1  style={{fontWeight:'bold', fontSize:'32px'}}>Web Development:</h1> 
        ...
        <div class="step-4" id="steps">
            ...
            <div id="text" > <h1  style={{fontWeight:'bold' , fontSize:'32px'}}>Content Creation:</h1>
    ...
    - Podcasting 
            ...
            <div id="image-container" data-hover-text="Content Creation" >
                ...
                <img src="images/image41.jpg" alt="" class="b-image"/>
