...
function Teamlayout() {
  ...
  >
        <div className='image w-[400px] bg-gray-100 h-64 mt-3 ml-3.5 mb-0.5 rounded-xl'><img src={member.image} alt={member.name} className='h-full w-full rounded-xl'></img> 
        </div>    
        <div className='description flex tracking-tighter flex-col mt-0 w-full p-4'>
            ...
            <div className='text-[#fff] text-xl font-normal flex tracking-tighter'>{member.specialization}</div>
